...
import { MapPin, Star, TrendingUp, Search, Users, Calendar, Shield, ArrowLeft, Filter } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      {/* Conditional Layout Based on Search State */}
      {!hasSearched ? (
        <>
        ...
        <>
          {/* Compact Search Header - Shown when searching */}
          <section className="py-8 px-4 bg-white shadow-sm sticky top-0 z-50">
            <div className="container mx-auto">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    {displayListings.length} {displayListings.length === 1 ? 'property' : 'properties'} found
                  </p>
                </div>
                ...
                <div className="text-center py-20">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => {
                        // Reset filters but keep search mode
                        handleSearch({
                          location: '',
                          checkIn: '',
                          checkOut: '',
